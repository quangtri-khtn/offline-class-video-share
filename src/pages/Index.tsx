...
const Index = () => {
  ...
  // Mock data representing the folder structure
  // In a real implementation, this would come from scanning the /videos/ directory
  useEffect(() => {
        ...
        {classes.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500">
              Vui lòng thêm các thư mục video vào /videos/
            </p>
          </div>
        )}
      </div>
